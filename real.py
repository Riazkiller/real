...
ua=random.choice([ua_nokia,ua_xiaomi,ua_samsung,ua_macos,ua_vivo,ua_oppo,ua_huawei,ua_redmi4a,ua_vivoy12,ua_nokiax,u
"""%(H,H,P,P))
...
def ___login___():
    os.system('clear')
    print(___logo___)
    print("%s[%s1%s]%s◍➤ Login by Token"%(RIAZ))
    print("%s[%s2%s]%s◍➤ Login by Cookie"%(RIAZ))
    print("%s[%s3%s]%s◍➤ Dapatkan Token Or Cookie"%(RIAZ))
    print("%s[%s4%s]%s◍➤ Keluar"%(RIAZ))
    ___login___ = raw_input("\n%s[%s?%s]%s Choose :%s "%(RIAZ))
...
def ___menu___():
    ...
    print("\n%s[%s1%s]%s◍➤ Dump ID Publik FAST CRACK [ 2004-2022 ]"%(RIAZ))
    print("%s[%s2%s]%s◍➤ Dump ID Publik Masal Old [ 2009-2006 ]"%(RIAZ))
    print("%s[%s3%s]%s◍➤ Dump ID Publik CRACK New [ 2020-2021 ]"%(RIAZ))
    print("%s[%s4%s]%s◍➤ Dump ID Publik Very Old [ 2006-2009 ]"%(RIAZ))
    print("%s[%s5%s]%s◍➤ Dump ID Follower Old [ 2015-2006 ]"%(RIAZ))
    print("%s[%s6%s]%s◍➤ Dump ID Follower New [ 2022-2020 ]"%(RIAZ))
    print("%s[%s7%s]%s◍➤ Dump ID Publik Acak [ 2022-2004 ]"%(RIAZ))
    print("%s[%s8%s]%s◍➤ Dump ID Publik Old [ 2006-2015 ]"%(RIAZ))
    print("%s[%s9%s]%s◍➤ Dump ID Publik New [ 2022-2020 ]"%(RIAZ))
    print("%s[%s10%s]%s◍➤ Start Crack %s[%sFast%s/%sSlow%s]"%(RIAZ))
    print("%s[%s11%s]%s◍➤ REZAULT  Crack"%(RIAZ))
    print("%s[%s12%s]%s◍➤ Laporkan Bug"%(RIAZ))
    print("%s[%s13%s]%s◍➤ DELETE Token"%(RIAZ))
